...
def send_mail(mail='chanchalsoni0722@gmail.com', name='test', msg='test message'):
    ...
    'Messages': [
    {
        ...
        "HTMLPart": f"<h3>Dear {name} </h3>, Hope you and your family is healthy and happy. <br> {msg} <br /> After this report please don't forget to consult with doctors. <br>May god bless you!",
